# https://raw.githubusercontent.com/eboda/mersenne-twister-recover/master/MersenneTwister.py
...
def test_PythonMT19937():
    import random
    seed = 0x3765176357613576317656731571653
