...
var setupEngine = exports.setupEngine = function setupEngine() {
  ...
  var layers = [[222, 269], [55, 300], [276, 102], [288, 277], [198, 161], [107, 100], [296, 17], [175, 148], [298, 325], [39, 220]];
  var layerVals = layers[Math.floor(Math.random() * layers.length)];
  var layer1Val = parseLayerParam(layerVals[0], { firstLayer: true });
  var layer2Val = parseLayerParam(layerVals[1], { firstLayer: false });
  var frameskip = 1;
  var aspectRatio = 0;
  var debug = false;
